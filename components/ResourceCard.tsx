...
export const ResourceCard: React.FC<ResourceCardProps> = ({
    ...
    return (
        ...
        >
            {/* Image Section */}
            <div className="relative w-full aspect-[16/9] bg-dark-900 overflow-hidden">
                <img 
                    src={imageUrl} 
                    alt={title}
                ...
                <div className="absolute top-3 left-3">
                    <span className="px-3 py-1 bg-black/60 backdrop-blur-md border border-white/10 text-white text-[10px] font-bold uppercase tracking-widest rounded-[5px]">
                        {category}
                    </span>
                </div>
            </div>
